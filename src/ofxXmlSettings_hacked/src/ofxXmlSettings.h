...
class ofxXmlSettings{
	...
	bool loadFile(const string& xmlFile){return false;};	//this is not relative to your data/ path - use ofDataPath(...) to make it relative
	...
	int 	getValue(const string&  tag, int            defaultValue, int which = 0){return 0;};
	double 	getValue(const string&  tag, double         defaultValue, int which = 0){return 0.0;};
		string 	getValue(const string&  tag, const string& 	defaultValue, int which = 0){return "";};

	int 	setValue(const string&  tag, int            value, int which = 0){return 0;};
	int 	setValue(const string&  tag, double         value, int which = 0){return 0;};
	int 	setValue(const string&  tag, const string& 	value, int which = 0){return 0;};
	...
	bool	pushTag(const string&  tag, int which = 0){return false;};
	int		popTag(){return 0;};
	int		getPushLevel(){return 0;};
	...
	int		getNumTags(const string& tag){return 0;};
	...
	int 	addValue(const string&  tag, int            value){return 0;};
	int 	addValue(const string&  tag, double         value){return 0;};
	int 	addValue(const string&  tag, const string& 	value){return 0;};

		int		addTag(const string& tag); //adds an empty tag at the current level

    
        // Attribute-related methods
	int		addAttribute(const string& tag, const string& attribute, int value, int which = 0){return 0;};
	int		addAttribute(const string& tag, const string& attribute, double value, int which = 0){return 0;};
	int		addAttribute(const string& tag, const string& attribute, const string& value, int which = 0){return 0;};
		
	int		addAttribute(const string& tag, const string& attribute, int value){return 0;};
	int		addAttribute(const string& tag, const string& attribute, double value){return 0;};
	int		addAttribute(const string& tag, const string& attribute, const string& value){return 0;};
	...
	int		getNumAttributes(const string& tag, int which = 0){return 0;};
		
	bool	attributeExists(const string& tag, const string& attribute, int which = 0){return false;};
		
	bool    getAttributeNames(const string& tag, vector<string>& outNames, int which = 0){return false;};
		
	int		getAttribute(const string& tag, const string& attribute, int defaultValue, int which = 0){return 0;};
	double	getAttribute(const string& tag, const string& attribute, double defaultValue, int which = 0){return 0.0;};
		string	getAttribute(const string& tag, const string& attribute, const string& defaultValue, int which = 0){return "";};
		
		int		setAttribute(const string& tag, const string& attribute, int value, int which = 0){return 0;};
		int		setAttribute(const string& tag, const string& attribute, double value, int which = 0){return 0;};;
		int		setAttribute(const string& tag, const string& attribute, const string& value, int which = 0){return 0;};;
		
		int		setAttribute(const string& tag, const string& attribute, int value){return 0;};;
		int		setAttribute(const string& tag, const string& attribute, double value){return 0;};;
		int		setAttribute(const string& tag, const string& attribute, const string& value){return 0;};;
